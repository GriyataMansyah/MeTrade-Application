            ...
            <table class="table table-bordered">
              <thead>
                <tr class="naupal">
                  ...
                  <th class="table-primary" scope="col">Jenis</th>
                  <th class="table-primary" scope="col">Nomor</th>
                  <th class="table-primary" scope="col">Tanggal</th>
                  <th class="table-primary" scope="col">Fasilitas</th>
                  <th class="table-primary" scope="col">Izin</th>
                  <th class="table-primary" scope="col">Kantor</th>
                  <th class="table-primary" scope="col">File</th>
