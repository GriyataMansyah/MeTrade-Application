...
<div class="d-none d-lg-block">
  <div class="row header animate__animated animate__fadeInDown">
    ...
    <div class="col-12 letaktom">
      <button class="a1 btn btn-secondary" onclick="muncul()">HI, <b>Pemula</b></button>
    </div>
...
<div class="popup position-absolute top-0 end-0 animate__animated animate__headShake" id="popup1">
  <div class="col-12 patas">
    <img src="images/logo2.png" class="hay">
    <a href="#">
...
<div class="d-none d-lg-block thisbody animate__animated animate__fadeIn">
  <div class="row">
    <h5 class="ha5 col-9">DATA MASTER BARANG</h5>
    <div class="col-3 drow1">
    <a href="/dataMaster"><div type="button" class="btn btn-primary drow"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
          <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
        </svg>
        <p class="dalambiru">Pusat Data Master</p>
      </div></a>
    </div>
  </div>
  <hr>
      ...
      <table class="table tabeldata">
        ...
        <tbody>
          <tr>
            <th scope="row">1</th>
            <td>HS</td>
            <td><button type="button" class="btn btn-primary" tpye="submit">Tambah</button></td>
...
<div class="d-block d-lg-none thisbody2 animate__animated animate__fadeIn">
  <div class="row">
    <h5 class="ha5 col-8 ">DATA MASTER BARANG</h5>
    <div class="col-4 drow1">

    <a href="/dataMaster"><div type="button" class="btn btn-primary drow2"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="hoh1 bi bi-house" viewBox="0 0 16 16">
          <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
        </svg>
        <p class="dalambiru">Pusat Data Master</p>
      </div></a>
...
<div class="sidebar d-none d-lg-block animate__animated animate__fadeInLeft" id="sidebar">
  <img src="images/logo.png" class="logoo animate__animated animate__fadeInDown">
