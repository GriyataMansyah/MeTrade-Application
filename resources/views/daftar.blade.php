              ...
              <hr>
                ...
                <div class="input-group has-validation inputa1">
                    ...
                    <div class="form-floating">
                      <input type="text" class="form-control input1" id="floatingInputGroup2" placeholder="Nomor Identitas (NPWP)" required>
                ...
                <!-- INI UNTUK NAMA LENGKAP -->
                  <div class="input-group has-validation inputa1">
                    ...
                    <div class="form-floating">
                      <input type="text" class="form-control input1" id="floatingInputGroup2" placeholder="Nama Lengkap" required>
                    ...
                    <!-- INI UNTUK No Telepon -->
                      <div class="input-group has-validation inputa1">
                        ...
                        <div class="form-floating">
                          <input type="password" class="form-control input1" id="floatingInputGroup2" placeholder="No Telepon" required>
                    ...
                    <div class="input-group has-validation inputa1">
                        ...
                        <div class="form-floating">
                          <input type="text" class="form-control input1" id="floatingInputGroup2" placeholder="E-mail" required>
                    ...
                    <!-- INI UNTUK Nama Pengguna -->
                      <div class="input-group has-validation inputa1">
                        ...
                        <div class="form-floating">
                          <input type="password" class="form-control input1" id="floatingInputGroup2" placeholder="Nama Pengguna" required>
