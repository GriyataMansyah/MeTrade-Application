...
<head>
    ...
    <div class="kotak">
      <div class="container-fluid  border border-1 ">
        <form class="mt-4">
          <div class="form-group row ">
            <!-- label 1 -->
            <label for="input1" class="col-sm-2 col-form-label">Value</label>
            <div class="col-sm-4">
      ...
      <div class="form-group row my-4">
        <!-- label 7 -->
        <label for="input1" class="col-sm-2 col-form-label">Berat Kotor (KGM)</label>
        <div class="col-sm-4">
          <input type="text" class="form-control" id="input1">
        </div>
      </div>
            ...
            <table class="table table-bordered">
              <thead>
                <tr class="naupal">
                  ...
                  <th class="table-primary" scope="col">Kode Bank</th>
                  <th class="table-primary" scope="col">Nama Bank</th>
                </tr>
              </thead>
              <tbody>
                <tr>
