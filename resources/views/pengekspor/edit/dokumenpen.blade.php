...
$dokumenPengguna = $Dokumen->where('id_dokumen', $id);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Data Dokumen Pendukung Update</title>
    ...
    <div class="d-none d-lg-block thisbody animate__animated animate__fadeIn">
      ...
      <div class="col-3 drow1">
        ...
        <a class="btn btn-success drow" href="{{ route('editangkut')}}"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16">
          <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z"/>
          <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2M9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5z"/>
        </svg><p class="dalambiru">Update</p></a>
      </div>
    </div> 
    <hr>
    <div class="offside">
            ...
            <table class="table table-bordered">
              ...
              @else
                <tr>
                  ...
                  {{-- TIDAK TERLIHAT --}}
                  <td class="inv" >
                    <form action="{{ route('hapus.dokumenpen2', $dp->id) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button type="submit" id="pencet1"></button>
                  </form>
                </td>
                {{-- ------------------------- --}}
                </tr>
              ...
              <div class="d-block d-lg-none thisbody2 animate__animated animate__fadeIn">
                <div class="row">
                  ...
                  <div class="col-4 drow1">
                    ...
                    <a class="btn btn-success drow2" href="{{ route('editangkut')}}"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="hoh1 bi bi-file-earmark-plus" viewBox="0 0 16 16">
  ...
  @include('layout.popupdokumenpen2')
