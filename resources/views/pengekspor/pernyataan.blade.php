...
<head>
    ...
    <div class="d-none d-lg-block thisbody animate__animated animate__fadeIn">
      ...
      <div class="col-3 drow1">
        ...
        <button type="submit" value="submit" onclick="verifikasi()" class="btn btn-primary drow"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16">
              ...
              <div class="d-block d-lg-none thisbody2 animate__animated animate__fadeIn">
                <div class="row">
                  ...
                  <div class="col-4 drow1">
                    ...
                    </svg><p class="dalambiru02" data-bs-toggle="modal" data-bs-target="#Modal" >Kirim</p></buuton>
                  </div>
                </div>
                  <hr>
                  <div class="offside2">
