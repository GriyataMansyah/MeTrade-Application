              ...
              <hr>
                ...
                <div class="input-group has-validation inputa1">
                    ...
                    <div class="form-floating">
                      <input type="text" class="form-control input1" id="floatingInputGroup2" placeholder="Nomor Identitas (NPWP)" name="npwp" required>
                  ...
                  <div class="input-group has-validation inputa1">
                    ...
                    <!-- INI UNTUK No Telepon -->
                      <div class="input-group has-validation inputa1">
                        ...
                        <div class="form-floating">
                          <input type="text" class="form-control input1" id="floatingInputGroup2" placeholder="No Telepon" name="no_hp" required oninput="this.value = this.value.replace(/[^0-9]/g, '');" >
