...
<head>
    ...
    .pungutan {
      background-color: rgb(172, 174, 174);
      width:100%;
      height:40px;
    }
        ...
        <div class="tabel1">
          <div class="table-responsive">
            <table class="table table-bordered">
              <thead>
                <tr class="kepalaa">
                  <th class="table-primary" scope="col">Pungutan</th>
                  <th class="table-primary" scope="col">Di Bayar</th>
                  <th class="table-primary" scope="col">Ditanggung Pemerintah</th>
                  <th class="table-primary" scope="col">Ditunda</th>
                  <th class="table-primary" scope="col">Tidak Dipungut</th>
                  <th class="table-primary" scope="col">Dibebaskan</th>
                  <th class="table-primary" scope="col">Sudah Dilunasi</th>
                </tr>
              </thead>
              <tbody>
                <tr>
