                ...
                <td>
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th class="table-primary asta" scope="col">Seri</th>
                          <th class="table-primary asta" scope="col">Jumlah</th>
                          <th class="table-primary asta" scope="col">Jenis</th>
                          <th class="table-primary asta" scope="col">Merek</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th class="table-primary asta" scope="col">Seri</th>
                        <th class="table-primary asta" scope="col">Nomor</th>
                        <th class="table-primary asta" scope="col">Ukuran</th>
                        <th class="table-primary asta" scope="col">Jenis</th>
                        <th class="table-primary asta" scope="col">Tipe</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
...
<div class="sidebar d-none d-lg-block animate__animated animate__fadeInLeft" id="sidebar">
  ...
  <div class="dropdown">
    <a href="#" class="dropdown-button">
      <h5 class="logo">
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-laptop"
          viewBox="0 0 16 16">
          <path
