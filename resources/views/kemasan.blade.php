...
<head>
  ...
  <title>Kemasan Dan Peti Kemas</title>
...
<div class="d-none d-lg-block thisbody animate__animated animate__fadeIn">
  <div class="row">
    ...
    <div class="col-3 drow1">
      ...
      <div type="button" class="btn btn-primary drow"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
        ...
        <p class="dalambiru" data-bs-toggle="modal" data-bs-target="#Modal">Lanjutkan</p>
      </div>
    </div>
  </div>
  <hr>
  ...
  <div class="kotak">
    <div class="kotakdalama">
      <p class="satu"><b>Wajib mengisi data kemasan</b></p>
    </div>
    <div class="row">
      <div class="col-6">
        <form>
          <table class="tables">
            <thead>
              <tr>
                <th class="th1a">
                  <div class="position-relative">Kemasan
                    <button type="button"
                    ...
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="table-primary asta  centered" scope="col">Jumlah</th>
                          <th class="table-primary asta centered" scope="col">Jenis</th>
                          <th class="table-primary asta centered" scope="col">Merek</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class='centered'>Tahan banting</td>
                          <td class='centered'>SNI</td>
      ...
      <div class="col-6">
        <table class="tabless">
          <thead>
            <tr>
              <th class="th1a">
                <div class="position-relative">Peti Kemas
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="table-primary asta centered" scope="col">Ukuran</th>
                        <th class="table-primary asta centered" scope="col">Jenis</th>
                        <th class="table-primary asta centered" scope="col">Tipe</th>
                        <th class="table-primary asta centered" scope="col"></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <td class="centered">XL</td>
                        <td class="centered">Kayu</td>
                        <td class="centered">Anti Pecah</td>
                        <td class="oe centered" >
                          <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                          <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z"/>
                          <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
...
<div class="d-block d-lg-none thisbody2 animate__animated animate__fadeIn">
  <div class="row">
    ...
    <div class="col-4 drow1">
      <div type="button" class="btn btn-primary drow2"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
