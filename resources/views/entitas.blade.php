              ...
              <tr>
                <td class="td1">
                  ...
                  <div class="input-group mb-3 input1">
                    <input type="text" class="form-control " placeholder="Nomor Identitas" aria-label="Username" aria-describedby="basic-addon1">
                  </div>
            ...
            <tbody>
              <tr>
                <td class="td1">
                  ...
                  Negara:<br><br>
                  <div class="input-group mb-3 input1">
                    <input type="text" class="form-control" placeholder="Negara" aria-label="Username" aria-describedby="basic-addon1">
                  </div>
                </td>
              </tr>
            </tbody>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr class="naupal">
                    ...
                    <th class="table-primary" scope="col">Nomor Identitas</th>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form >
                        ...
                        <div class="form-group row mb-3">
                          <label  class="control-label col-3 col-form-label"><p class="h6 text-secondary">Nomor Identitas</p></label>
                          <div class="offset-1 col-8">
                          <input type="text" class="form-control" >
                          </div>
                        </div>
                        <div class="form-group row mb-3">
                          <label  class="control-label col-3 col-form-label"><p class="h6 text-secondary">Alamat</p></label>
                          <div class="offset-1 col-8">
                            <textarea type="text" class="form-control " placeholder="Alamat" aria-label="Username" aria-describedby="basic-addon1"></textarea>
                          </div>
                        </div>
                        <div class="form-group row mb-3">
                          <label  class="control-label col-3 col-form-label"><p class="h6 text-secondary">Nama</p></label>
                          <div class="offset-1 col-8">
                          <input type="text" class="form-control" >
                          </div>
                        </div>
