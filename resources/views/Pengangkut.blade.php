      ...
      <div class="kotakk">
        <div class="table-responsive">
            <table class="table table-bordered">
              <thead>
                <tr class="naupal">
                  <th class="table-primary" scope="col">Seri</th>
                  <th class="table-primary" scope="col">Nama Sarkut</th>
                  <th class="table-primary" scope="col">Nomor Pengangkut</th>
                  <th class="table-primary" scope="col">Cara Pengangkut</th>
                  <th class="table-primary" scope="col">Bendera</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                    ...
                    <div class="modal-body">
                      <form >
                        <div class="form-group row mb-3">
                          <label  class="control-label col-3 col-form-label"><p class="h6 text-secondary">Seri</p></label>
                          <div class="offset-1 col-8">
                          <input type="text" class="form-control" disabled>
                          </div>
                        </div>
                        <div class="form-group row mb-3">
                          <label  class="control-label col-3 col-form-label"><p class="h6 text-secondary">Nama Sarana Angkut</p></label>
                          <div class="offset-1 col-8">
                          <input type="text" class="form-control" >
                          </div>
                        </div>
                        <div class="form-group row mb-3">
                          <label  class="control-label col-3 col-form-label"><p class="h6 text-secondary">Cara Pengangkutan</p></label>
                          <div class="offset-1 col-8">
                        ...
                        <div class="form-group row mb-3">
                          <label  class="control-label col-3 col-form-label"><p class="h6 text-secondary">Nomor Voy/Flight</p></label>
                          <div class="offset-1 col-8">
                          <input type="text" class="form-control" >
                          </div>
                        </div>
                        <div class="form-group row mb-3">
                          <label  class="control-label col-3 col-form-label"><p class="h6 text-secondary">Bendera</p></label>
                          <div class="offset-1 col-8">
                            <select class="form-select ">
                              <option>... </option>
                            <option value="1">Pilihan 1 </option>
